...
properti property[32] = {
    /*
        nama tempat, pemilik, level, harga sesuai level, harga upgrade
    */

    {{"0"}, -1, 0, {0,0,0,0,0},0},                                      // Start
    ...
    {{"0"}, -1, 0, {0,0,0,0,0},0},                                      // Penjara
    {{"0"}, -1, 0, {0,0,0,0,0},0},                                      // Kantor Pajak
    {{"Cicendo"}, -1, 0, {70, 95, 120, 145, 170}, 50},
    ...
    {{"0"}, -1, 0, {0,0,0,0,0},0},                                      // Kartu Kesempatan
    {{"Coblong"}, -1, 0, {190, 240, 290, 340, 390}, 100},
    {{"0"}, -1, 0, {0,0,0,0,0},0},                                      // Kantor Pajak
    {{"Bandung Wetan"}, -1, 0, {200, 245, 295, 345, 395}, 100},
